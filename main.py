		...
		if hour == 18:
			...
			if monster.nonplayerchar.destset == False:
				...
				if n ==  'shop':
					...
					monster.nonplayerchar.destset = True
				if n == 'bar':
					monster.nonplayerchar.setx = 12
					monster.nonplayerchar.sety = 26
					monster.nonplayerchar.destset = True
	...
	for i in range(num_items):
		...
		if not is_blocked(x, y):
			...
			## weapons
				...
				item = Object(x, y, 231, 'a revolver', libtcod.sky, make='Vorikov',
			...
			if key_char == 'e':
				...
				for obj in objects:
					if obj.x == x and obj.y == y and obj.furniture:
						obj.furniture.use_function(obj, opened=False)
